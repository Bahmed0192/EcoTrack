...
export function GlobalDataViz() {
  ...
  const [points, setPoints] = useState([
    { id: 1, x: 15, y: 20, label: "North America", value: 2.3, suffix: "M", color: "#10B981" },
    { id: 2, x: 45, y: 25, label: "Europe", value: 1.8, suffix: "M", color: "#3B82F6" },
    { id: 3, x: 70, y: 35, label: "Asia", value: 4.1, suffix: "M", color: "#10B981" },
    { id: 4, x: 20, y: 65, label: "South America", value: 890, suffix: "K", color: "#F59E0B" },
    { id: 5, x: 50, y: 70, label: "Africa", value: 1.2, suffix: "M", color: "#3B82F6" },
    { id: 6, x: 80, y: 75, label: "Australia", value: 520, suffix: "K", color: "#10B981" },
  ]);
                ...
                <motion.div key={point.id}
                  ...
                  <motion.div initial={{ opacity: 0, y: 10 }}
                    ...
                    <div className="font-semibold transition-all duration-300" style={{ color: point.color }}>
                      {point.suffix === "M" ? point.value.toFixed(2) : Math.round(point.value)}{point.suffix}
                    </div>
                    <div className="text-xs text-white/40">tons saved</div>
                  </motion.div>
                </motion.div>
              ))}
